      ...
      <section className={styles.pricing}>
        <div className={`container ${styles.pricingContainer}`}>
          ...
          <p className={styles.subtitle}>
            ...
            Tired of unpredicatble pricing, and complex billing structure? Save up to <a href="https://signoz.io/blog/pricing-comparison-signoz-vs-datadog-vs-newrelic-vs-grafana/?utm_source=pricing_page&utm_medium=website"><u>86% on your Datadog bill</u></a> with SigNoz.
          </p>
