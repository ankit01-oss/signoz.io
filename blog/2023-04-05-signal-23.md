...
Last month, our team worked on improving the search capabilities across multiple tabs. We also made the logs tab more intuitive by adding color coding in the logs view. We also presented SigNoz at an observability-focused meetup and crossed 12,000+ GitHub stars.
...
Latest release - [v0.18.1](https://github.com/SigNoz/signoz/releases/tag/v0.18.1)

Earlier releases - [v0.18.0](https://github.com/SigNoz/signoz/releases/tag/v0.18.0), [v0.17.0](https://github.com/SigNoz/signoz/releases/tag/v0.17.0)
...
We have also improved the logs view with color-coded logs data in different compact views of logs. This improves the readability while going through logs data which is often huge.
...
We are making continuous improvements in analytics of all three types of telemetry signals - logs, metrics, and traces. We have improved the user experience by covering more corner cases for metrics-related charts.
...
[Export Logs/Metrics/Traces for a specific `trace_id`](https://github.com/SigNoz/signoz/issues/2467)
...
So we want to understand the scenarios where a user might need to export telemetry signals to do the debugging rather than do it with SigNoz UI. If you have similar use cases, feel free to share your use case on this [GitHub issue](https://github.com/SigNoz/signoz/issues/2467).
...
We presented SigNoz at an Observability-focused session organized by Accel India in Bengaluru. [Ankit Nayan](https://www.linkedin.com/in/ankitnayan/) talked about how we are democratizing observability through open source at SigNoz. It was great to see an engaged developer audience curious to learn more about how they can run their applications better with observability.
...
You can find highlights from the APAC and other sessions [here](https://opentelemetry.io/blog/2023/end-user-discussions-03/).

### Becoming the Developer’s choice for an Observability Stack

It’s great to see the community adoption of SigNoz has made it a top choice for an observability backend. Self-serve infrastructure providers like [Argonaut](https://www.argonaut.dev/) have created integrations on their platform to enable observability for their users with SigNoz. 
